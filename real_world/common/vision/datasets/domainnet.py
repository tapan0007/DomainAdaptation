...
class DomainNet(ImageList):
    ...
    def __init__(self, root: str, task: str, domain_index: int, phase, split: Optional[str] = 'train', download: Optional[float] = False,**kwargs):
        ...
        super(DomainNet, self).__init__(root, DomainNet.CLASSES, phase=phase, data_list_file=data_list_file, domain_index=domain_index,**kwargs)
